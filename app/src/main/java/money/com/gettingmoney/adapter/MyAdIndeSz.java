 ...
 * 指数-深圳适配器
 */
public class MyAdIndeSz  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<IndeXBean.ListResponses2Bean> dataBeen = new ArrayList<>();

    public MyAdIndeSz(List<IndeXBean.ListResponses2Bean> dataBeen) {
