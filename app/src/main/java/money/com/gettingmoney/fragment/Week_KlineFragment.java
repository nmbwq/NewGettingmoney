 ...
 */
public class Week_KlineFragment extends Fragment {
    ...
    private LoadingDialog dialogbyweek;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fg_weekline, container, false);
        ...
        if (bundle != null) {
            ...
            dialogbyweek = new LoadingDialog(getActivity(), "正在加载周K线图");
            dialogbyweek.show();
            if ("板块".equals(type) && !("").equals(String.valueOf(stockId))) {
                ...
                K_IndexshockedGanggu();
                initChart();
                Toast.makeText(getContext(), "港股指数详情进入到周K线图", Toast.LENGTH_SHORT).show();
            }else if ("沪深指数".equals(type) && !("").equals(String.valueOf(stockId))) {
                K_Indexshocked();
                initChart();
                Toast.makeText(getContext(), "沪深指数详情进入到周K线图", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    void K_getByWeek() {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                indexuti.domainStockgetByWeek(dialogbyweek, stockId, new MyXutils.XCallBack() {
                    @Override
                    public void onResponse(String result) {
                        Log.i("板块的周k线图股票接口111111", result);
                        ...
                        Log.i("板块的周k线图股票接口111111", "111");

                        stockHistoryListBeans.clear();
                        Log.i("板块的周k线图股票接口111111", "222");
    ...
    void K_Indexshocked() {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                indexuti.indexbranchTime(dialogbyweek, stockId, "week", new MyXutils.XCallBack() {
                    @Override
                    public void onResponse(String result) {
    ...
    //港股指数的周K线图股票网络
    void K_IndexshockedGanggu() {
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
                indexuti indexuti = new indexuti();

                indexuti.indexbranchTimeGang(dialogbyweek, stockId, "week", 5, new MyXutils.XCallBack() {
                    @Override
                    public void onResponse(String result) {
        ...
        * */
        ...
        combinedchart_byday.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                Log.i("高亮联动板块K线图BBBBBB11", e.toString());
                Log.i("高亮联动板块K线图BBBBBB22", dataSetIndex + "");
                Log.i("高亮联动板块K线图BBBBBB33", h.toString());
